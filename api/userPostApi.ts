...
const storeUserPost = async (userId: number, title: string, description: string = ''): Promise<any> => {
  try {
    let payload: any = {
      user_id: userId,
      title: title,
...
const updateUserPost = async (id: number, userId: number, title: string, description: string = ''): Promise<any> => {
  try {
    let payload: any = {
      user_id: userId,
      title: title,
